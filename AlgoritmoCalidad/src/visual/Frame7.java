...
public class Frame7 extends JFrame{
	...
	public Frame7(Algoritmo algoritmo) {
		Algoritmo = algoritmo;
		paint();
	...
	private void paint() {
		...
		panel.add(btnNext);
		 btnNext.addActionListener(new ActionListener() {
			...
			JLabel lblOp1 = new JLabel("Muestra un mensaje con la descripción del error ocurrido.");
			...
			JLabel lblOp21 = new JLabel("Es tratarlo correctamente, de forma que se lo pueda resolver ");
			lblOp21.setBounds(60, 112, 387, 16);
			panel.add(lblOp21);
			
			JLabel lblOp3 = new JLabel("y continuar con el funcionamiento del sistema.");
			lblOp3.setBounds(60, 131, 365, 16);
			panel.add(lblOp3);
