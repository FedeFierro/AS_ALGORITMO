...
public class Frame5 extends JFrame{
	...
	public Frame5(Algoritmo algoritmo) {
		Algoritmo = algoritmo;
		paint();
	...
	private void paint() {
		...
		panel.add(btnNext);
		 btnNext.addActionListener(new ActionListener() {
			...
			JLabel lblTexto = new JLabel("Tiempo de respuesta a solicitudes del usuario.");
			lblTexto.setBounds(26, 49, 381, 16);
			panel.add(lblTexto);
			
			JLabel lblOp1 = new JLabel("Menos de 2 segundos en procesar una solicitud.");
			lblOp1.setBounds(60, 77, 387, 23);
			panel.add(lblOp1);
			
			JLabel lblOp21 = new JLabel("Entre 2 y 5 segundos en procesar una solicitud.");
			lblOp21.setBounds(60, 119, 359, 16);
			panel.add(lblOp21);
			
			JLabel lblOp3 = new JLabel("Mas de 5 segundos en procesar una solicitud.");
