...
public class Frame6 extends JFrame{
	...
	public Frame6(Algoritmo algoritmo) {
		Algoritmo = algoritmo;
		paint();
	...
	private void paint() {
		...
		panel.add(btnNext);
		 btnNext.addActionListener(new ActionListener() {
			...
			JLabel lblTexto = new JLabel("Ante la aparición de algún error. Puede decir que:");
			...
			JLabel lblOp1 = new JLabel("se protegen los datos procesados.");
			...
			JLabel lblOp21 = new JLabel("Se realiza un log de actividades que el sistema estaba haciendo.");
			lblOp21.setBounds(60, 112, 359, 16);
			panel.add(lblOp21);
			
			chkOp3 = new JCheckBox("");
			chkOp3.setBounds(26, 147, 28, 23);
			panel.add(chkOp3);
			
			JLabel lblOp3 = new JLabel("Se realiza un log describiendo la falla.");
			lblOp3.setBounds(60, 150, 365, 16);
			panel.add(lblOp3);
